...
/////////////////////////////////////////////////////////////////////////////
// CFpspread_point 래퍼 클래스입니다.

class CFpspread_point : public CWnd
{
protected:
	DECLARE_DYNCREATE(CFpspread_point)
public:
...
enum
{
    TabStripButtonPolicyAsNeeded = 0,
    TabStripButtonPolicyAlways = 1,
    TabStripButtonPolicyNever = 2
}TabStripButtonPolicyConstants;
enum
{
    AppearanceStyleClassic = 0,
    AppearanceStyleVisualStyles = 1,
    AppearanceStyleEnhanced = 2
}AppearanceStyleConstants;
enum
{
    ScrollBarStyleInherit = 0,
    ScrollBarStyleClassic = 1,
    ScrollBarStyleVisualStyle = 2,
    ScrollBarStyleEnhanced = 3
}ScrollBarStyleConstants;
enum
{
    UseVisualStylesInherit = 0,
    UseVisualStylesYes = 1,
    UseVisualStylesNo = 2
}UseVisualStylesConstants;
enum
{
    TabEnhancedShapeRectangle = 0,
    TabEnhancedShapeRoundedRectangle = 1,
    TabEnhancedShapeTrapezoid = 2,
    TabEnhancedShapeIsoscelesTrapezoid = 3
}TabEnhancedShapeConstants;
enum
{
    CellNoteIndicatorShapeSquare = 0,
    CellNoteIndicatorShapeTriangle = 1
}CellNoteIndicatorShapeConstants;
enum
{
    HighlightHeadersDefault = 0,
    HighlightHeadersOff = 1,
    HighlightHeadersOn = 2
}HighlightHeadersConstants;
enum
{
    HighlightStyleDefault = 0,
    HighlightStyleInvert = 1,
    HighlightStyleColor = 2,
    HighlightStyleAlphaBlend = 3
}HighlightStyleConstants;
enum
{
    ...
    ExportRangeToTextFileCheckBoxFalse = 32
...
enum
{
    ...
    ExportToTextFileCheckBoxFalse = 32
...
enum
{
    ...
    EventCircularFormula = 53,
    EventCTCancelEditing = 54,
    EventCTCreateEditorControl = 55,
    EventCTCreateRendererControl = 56,
    EventCTGetEditorValue = 57,
    EventCTInitializeControl = 58,
    EventCTIsReservedKey = 59,
    EventCTIsReservedLocation = 60,
    EventCTIsValid = 61,
    EventCTGetPreferredSize = 62,
    EventCTGetReservedCursor = 63,
    EventCTPaintCell = 64,
    EventCTSetValue = 65,
    EventCTStartEditing = 66,
    EventCTStopEditing = 67,
    EventCTStringFormat = 68,
    EventCTStringUnformat = 69
...
//
	...
	BOOL get_EventEnabled(short EventID)
	{
		BOOL result;
		static BYTE parms[] = VTS_I2 ;
		InvokeHelper(0x1f6, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, parms, EventID);
		return result;
	}
	void put_EventEnabled(short EventID, BOOL newValue)
	{
		static BYTE parms[] = VTS_I2 VTS_BOOL ;
		InvokeHelper(0x1f6, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, EventID, newValue);
	}
	...
	BOOL SetEnhancedSheetTabColors(long clrNormalUpperStartColor, long clrNormalUpperEndColor, long clrNormalLowerStartColor, long clrNormalLowerEndColor, long clrHoverUpperStartColor, long clrHoverUpperEndColor, long clrHoverLowerStartColor, long clrHoverLowerEndColor, long clrTabOuterBorderColor, long clrTabInnerBorderColor, long clrButtonUpperNormalStartColor, long clrButtonUpperNormalEndColor, long clrButtonLowerNormalStartColor, long clrButtonLowerNormalEndColor, long clrButtonUpperHoverStartColor, long clrButtonUpperHoverEndColor, long clrButtonLowerHoverStartColor, long clrButtonLowerHoverEndColor, long clrButtonUpperPushedStartColor, long clrButtonUpperPushedEndColor, long clrButtonLowerPushedStartColor, long clrButtonLowerPushedEndColor, long clrArrowColor, long clrBackColorStartColor, long clrBackColorEndColor, long clrSplitBoxStartColor, long clrSplitBoxEndColor, long clrSheetTabForeColor, long clrSheetTabActiveForeColor)
	{
		BOOL result;
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0x20e, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, clrNormalUpperStartColor, clrNormalUpperEndColor, clrNormalLowerStartColor, clrNormalLowerEndColor, clrHoverUpperStartColor, clrHoverUpperEndColor, clrHoverLowerStartColor, clrHoverLowerEndColor, clrTabOuterBorderColor, clrTabInnerBorderColor, clrButtonUpperNormalStartColor, clrButtonUpperNormalEndColor, clrButtonLowerNormalStartColor, clrButtonLowerNormalEndColor, clrButtonUpperHoverStartColor, clrButtonUpperHoverEndColor, clrButtonLowerHoverStartColor, clrButtonLowerHoverEndColor, clrButtonUpperPushedStartColor, clrButtonUpperPushedEndColor, clrButtonLowerPushedStartColor, clrButtonLowerPushedEndColor, clrArrowColor, clrBackColorStartColor, clrBackColorEndColor, clrSplitBoxStartColor, clrSplitBoxEndColor, clrSheetTabForeColor, clrSheetTabActiveForeColor);
		return result;
	}
	BOOL SetEnhancedScrollBarColors(long clrTrackColor, long clrArrowColor, long clrUpperNormalStartColor, long clrUpperNormalEndColor, long clrLowerNormalStartColor, long clrLowerNormalEndColor, long clrUpperPushedStartColor, long clrUpperPushedEndColor, long clrLowerPushedStartColor, long clrLowerPushedEndColor, long clrUpperHoverStartColor, long clrUpperHoverEndColor, long clrLowerHoverStartColor, long clrLowerHoverEndColor, long clrHoverButtonBorderColor, long clrButtonBorderColor)
	{
		BOOL result;
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0x20f, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, clrTrackColor, clrArrowColor, clrUpperNormalStartColor, clrUpperNormalEndColor, clrLowerNormalStartColor, clrLowerNormalEndColor, clrUpperPushedStartColor, clrUpperPushedEndColor, clrLowerPushedStartColor, clrLowerPushedEndColor, clrUpperHoverStartColor, clrUpperHoverEndColor, clrLowerHoverStartColor, clrLowerHoverEndColor, clrHoverButtonBorderColor, clrButtonBorderColor);
		return result;
	}
	BOOL SetEnhancedColumnHeaderColors(long clrSelectedHoverUpperColor, long clrSelectedHoverLowerColor, long clrSelectedUpperColor, long clrSelectedLowerColor, long clrHoverUpperColor, long clrHoverLowerColor, long clrUpperColor, long clrLowerColor, long clrSelectedBorderColor, long clrBorderColor)
	{
		BOOL result;
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0x210, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, clrSelectedHoverUpperColor, clrSelectedHoverLowerColor, clrSelectedUpperColor, clrSelectedLowerColor, clrHoverUpperColor, clrHoverLowerColor, clrUpperColor, clrLowerColor, clrSelectedBorderColor, clrBorderColor);
		return result;
	}
	BOOL SetEnhancedRowHeaderColors(long clrSelectedHoverUpperColor, long clrSelectedHoverLowerColor, long clrSelectedUpperColor, long clrSelectedLowerColor, long clrHoverUpperColor, long clrHoverLowerColor, long clrUpperColor, long clrLowerColor, long clrSelectedBorderColor, long clrBorderColor)
	{
		BOOL result;
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0x211, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, clrSelectedHoverUpperColor, clrSelectedHoverLowerColor, clrSelectedUpperColor, clrSelectedLowerColor, clrHoverUpperColor, clrHoverLowerColor, clrUpperColor, clrLowerColor, clrSelectedBorderColor, clrBorderColor);
		return result;
	}
	BOOL SetEnhancedCornerColors(long BackColor, long hoverBackColor, long triangleColor, long triangleHoverColor, long triangleBorderColor, long triangleHoverBorderColor)
	{
		BOOL result;
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0x212, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, BackColor, hoverBackColor, triangleColor, triangleHoverColor, triangleBorderColor, triangleHoverBorderColor);
		return result;
	}
	...
	{
		BOOL result;
		static BYTE parms[] = VTS_BSTR VTS_BOOL VTS_BSTR VTS_BSTR VTS_BSTR VTS_BSTR VTS_BSTR VTS_BSTR VTS_BSTR ;
		InvokeHelper(0x218, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, FileName, AppendFlag, LogFile, TitleStr, CssFile, TableClass, TRClass, TDClass, THClass);
		return result;
	}
	...
	{
		BOOL result;
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_BSTR VTS_BOOL VTS_BSTR VTS_BSTR VTS_BSTR VTS_BSTR VTS_BSTR VTS_BSTR VTS_BSTR ;
		InvokeHelper(0x219, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, Col, Row, Col2, Row2, FileName, AppendFlag, LogFile, TitleStr, CssFile, TableClass, TRClass, TDClass, THClass);
		return result;
	}
	...
	BOOL LoadFromBuffer(VARIANT * Buff)
	{
		BOOL result;
		static BYTE parms[] = VTS_PVARIANT ;
		InvokeHelper(0x21e, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, Buff);
		return result;
	}
	VARIANT SaveBlockToBuffer(long Col, long Row, long Col2, long Row2, BOOL fSaveColInfo, BOOL fSaveRowInfo)
	{
		...
		InvokeHelper(0x21f, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, Col, Row, Col2, Row2, fSaveColInfo, fSaveRowInfo);
		return result;
	}
	BOOL LoadBlockFromBuffer(long Col, long Row, long Col2, long Row2, VARIANT * Buff)
	{
		...
		InvokeHelper(0x220, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, Col, Row, Col2, Row2, Buff);
		return result;
	}
	BOOL AddCustomCellType(LPCTSTR Name, BOOL Editable, BOOL CanOverflow, BOOL CanBeOverflown, BOOL UseRendererControl)
	{
		BOOL result;
		static BYTE parms[] = VTS_BSTR VTS_BOOL VTS_BOOL VTS_BOOL VTS_BOOL ;
		InvokeHelper(0x223, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, Name, Editable, CanOverflow, CanBeOverflown, UseRendererControl);
		return result;
	}
	BOOL RemoveCustomCellType(LPCTSTR Name)
	{
		BOOL result;
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x224, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, Name);
		return result;
	}
	BOOL EnumCustomCellType(LPCTSTR PrevName, BSTR * Name)
	{
		BOOL result;
		static BYTE parms[] = VTS_BSTR VTS_PBSTR ;
		InvokeHelper(0x225, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, PrevName, Name);
		return result;
	}
	BOOL GetCustomCellType(LPCTSTR Name, BOOL * Editable, BOOL * CanOverflow, BOOL * CanBeOverflown, BOOL * UseRendererControl)
	{
		BOOL result;
		static BYTE parms[] = VTS_BSTR VTS_PBOOL VTS_PBOOL VTS_PBOOL VTS_PBOOL ;
		InvokeHelper(0x226, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, Name, Editable, CanOverflow, CanBeOverflown, UseRendererControl);
		return result;
	}
	VARIANT GetCustomEditor(LPCTSTR Name, long Style)
	{
		VARIANT result;
		static BYTE parms[] = VTS_BSTR VTS_I4 ;
		InvokeHelper(0x229, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, Name, Style);
		return result;
	}
	VARIANT GetCustomRenderer(LPCTSTR Name, long Style)
	{
		VARIANT result;
		static BYTE parms[] = VTS_BSTR VTS_I4 ;
		InvokeHelper(0x22a, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, Name, Style);
		return result;
	}
	BOOL PaintControl(VARIANT Ctrl, long hDC, long Left, long Top, long Right, long Bottom, BOOL ClientOnly)
	{
		BOOL result;
		static BYTE parms[] = VTS_VARIANT VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_BOOL ;
		InvokeHelper(0x22b, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, &Ctrl, hDC, Left, Top, Right, Bottom, ClientOnly);
		return result;
	}
	long GetFontHandle(LPDISPATCH Font)
	{
		...
		InvokeHelper(0x22c, DISPATCH_METHOD, VT_I4, (void*)&result, parms, Font);
		return result;
	}
	BOOL OpenExcel2007File(LPCTSTR FileName, LPCTSTR Password, short Sheet, short ExcelSheet, LPCTSTR LogFileName)
	{
		BOOL result;
		static BYTE parms[] = VTS_BSTR VTS_BSTR VTS_I2 VTS_I2 VTS_BSTR ;
		InvokeHelper(0x231, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, FileName, Password, Sheet, ExcelSheet, LogFileName);
		return result;
	}
	BOOL SaveExcel2007File(LPCTSTR FileName, LPCTSTR Password, long Flags, LPCTSTR LogFileName)
	{
		BOOL result;
		static BYTE parms[] = VTS_BSTR VTS_BSTR VTS_I4 VTS_BSTR ;
		InvokeHelper(0x232, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, FileName, Password, Flags, LogFileName);
		return result;
	}
	long IsExcel2007File(LPCTSTR FileName)
	{
		long result;
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x233, DISPATCH_METHOD, VT_I4, (void*)&result, parms, FileName);
		return result;
	}
	void Refresh()
	{
...
CPictureFpsread GetTypePictPicture()
{
	LPDISPATCH result;
...
void SetAppearanceStyle(long propVal)
{
...
void SetTabEnhancedShape(long propVal)
{
...
{
	unsigned long result;
	GetProperty(0x216, VT_UI4, (void*)&result);
	return result;
}
void SetCellNoteIndicatorColor(unsigned long propVal)
{
	SetProperty(0x216, VT_UI4, propVal);
}
...
void SetCellNoteIndicatorShape(long propVal)
{
...
void SetTabStripButtonPolicy(long propVal)
{
...
void SetHighlightHeaders(long propVal)
{
...
void SetHighlightStyle(long propVal)
{
...
{
	unsigned long result;
	GetProperty(0x221, VT_UI4, (void*)&result);
	return result;
}
void SetHighlightAlphaBlendColor(unsigned long propVal)
{
	SetProperty(0x221, VT_UI4, propVal);
}
...
void SetHighlightAlphaBlend(short propVal)
{
...
void SetTypeCustomName(CString propVal)
{
...
void SetTypeCustomStyle(long propVal)
{
...
void SetTypeCustomItemData(VARIANT propVal)
{
...
void SetUseVisualStyles(long propVal)
{
...
void SetEnhanceStaticCells(BOOL propVal)
{
...
void SetScrollBarStyle(long propVal)
{
