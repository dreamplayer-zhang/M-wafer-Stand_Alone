...
/*  ImageButton.cpp													*/
/*																	*/
/*  Implementation of the CImageButton.								*/
/*																	*/
/*	This class is based on the Microsoft's WTL class CBitmapButton.	*/
/*	It has been modified to work with MFC and there are some 		*/
/*	features added, such as button text, autoload and transparancy.	*/
/*																	*/
...
/*																	*/
/********************************************************************/
BOOL CImageButton::OnMouseLeave(WPARAM wParam, LPARAM lParam) 
{
	if(m_bMouseOver)
	{
		m_bMouseOver = FALSE;
